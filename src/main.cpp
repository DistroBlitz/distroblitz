...
unsigned int nStakeMinAge =  60 * 60 * 8;	// minimum age for coin age: 8hrs
...
int64 nChainStartTime = 1399995291;
...
const string strMessageMagic = "DistroBlitz Signed Message:\n";
...
const int YEARLY_BLODBOUNT = 5256000;	 
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    int64 nRewardCoinYear;
	nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE;

	if(nHeight < YEARLY_BLODBOUNT)
		nRewardCoinYear = 12.5 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (2 * YEARLY_BLODBOUNT))
		nRewardCoinYear = 5 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (3 * YEARLY_BLODBOUNT))
		nRewardCoinYear = 3 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (4 * YEARLY_BLODBOUNT))
		nRewardCoinYear = 5 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (5 * YEARLY_BLODBOUNT))
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DistroBlitz
    bool fStrictPayToScriptHash = true; // Always active in DistroBlitz
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DistroBlitz", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "DistroBlitz Developers 1399995291";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1399995291;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1426337;
        ...
        assert(block.hashMerkleRoot == uint256("0x9c7336743234ca65dc1e1597030f13094d4e90cfc59c4b5c8388c1c9771a13ca"));
